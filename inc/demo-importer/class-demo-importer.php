...
/**
 * Suffice_Demo_Importer Class.
 */
class Suffice_Demo_Importer {
	...
	public function __construct() {
		$this->plugin_data = array(
			...
			'name' => __( 'ThemeGrill Demo importer', 'suffice' ),
		);
	...
	public function add_admin_menu() {
		add_theme_page( __( 'Demo Importer', 'suffice' ), __( 'Demo Importer', 'suffice' ), 'switch_themes', 'demo-importer', array( $this, 'demo_importer' ) );
	}
